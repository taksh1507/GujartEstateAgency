  ...
  return (
    <div className={`flex items-center space-x-2 ${className}`}>
      ...
      <div className="relative">
        <Building2 className={`h-8 w-8 text-primary-600 ${iconClassName}`} />
      ...
      {showText && (
        <div className={`font-bold text-xl ${textClassName}`}>
          <span className="text-primary-600">Gujarat</span>
          <span className="text-secondary-500 ml-1">Estate</span>
